...
import com.example.app_rapchieuphim.Adapter.ImageListAdapter;
import com.example.app_rapchieuphim.Domain.FilmItem;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        progressBar = findViewById(R.id.detailoadding);
        ...
        movieSummaryInfo = findViewById(R.id.movieSumaryInfo);
        movieActorsInfo = findViewById(R.id.movieActorInfor);
